...
def describe_FileEventHandler():
    ...
    def describe_on_modified():
        ...
        def it_handles_unknown_file_types_gracefully(handler):
            ...
            with patch.object(handler, '_get_processor', return_value=None) as mock_get_processor:
                with patch('src.pipeline.data_writer.db_handler.DatabaseHandler') as MockDatabaseHandler:
                    handler.on_modified(mock_event)
