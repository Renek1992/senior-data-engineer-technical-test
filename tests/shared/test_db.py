    ...
    def describe_connect_method():
        ...
        def it_connects_when_not_connected(mock_connect, db_connector):
            ...
            mock_connect.assert_called_once_with(
                dsn=db_connector.config.postgres_url, cursor_factory=RealDictCursor
            )
        ...
        def it_does_not_reconnect_when_already_connected(mock_connect, db_connector):
            ...
            db_connector.logger.info.assert_called_once_with(
...
def describe_database_operations():
    ...
    def describe_initialization():
        def it_properly_initializes_instance(
            db_operations, mock_db_connector, mock_logger
        ):
            """Test that the constructor properly initializes the instance."""
    ...
    def describe_execute_query_method():
        def it_connects_to_database_before_executing_query(
            db_operations, mock_db_connector
        ):
        ...
        def it_executes_query_with_provided_parameters(
            db_operations, mock_db_connector
        ):
        ...
        def it_returns_results_when_query_has_results(db_operations, mock_db_connector):
            ...
            cursor_mock.description = [
                "column1",
                "column2",
            ]  # Non-None description indicates results
        ...
        def it_commits_transaction_when_query_has_no_results(
            db_operations, mock_db_connector
        ):
        ...
        def it_closes_connection_after_query_execution(
            db_operations, mock_db_connector
        ):
    ...
    def describe_integration_scenarios():
        def it_executes_full_query_workflow_for_insert(
            db_operations, mock_db_connector, mock_logger
        ):
